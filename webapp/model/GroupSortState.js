sap.ui.define([
	...
	return BaseObject.extend("sap.ui.teched.appUnderTest.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias sap.ui.teched.appUnderTest.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "SalesOrderId");
			}
